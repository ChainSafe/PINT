...
///
/// This is a generic version of the `pallet_proxy::Call` enum generated by the substrate pallet
/// macros
...
#[derive(Encode, Decode, Clone, PartialEq, RuntimeDebug, Default, scale_info::TypeInfo)]
