...
{
	while frame_system::Pallet::<PintRuntime>::block_number() < n {
		pallet_remote_asset_manager::Pallet::<PintRuntime>::on_finalize(
			frame_system::Pallet::<PintRuntime>::block_number(),
		);
		frame_system::Pallet::<PintRuntime>::on_finalize(frame_system::Pallet::<PintRuntime>::block_number());
		frame_system::Pallet::<PintRuntime>::set_block_number(frame_system::Pallet::<PintRuntime>::block_number() + 1);
		frame_system::Pallet::<PintRuntime>::on_initialize(frame_system::Pallet::<PintRuntime>::block_number());
		pallet_remote_asset_manager::Pallet::<PintRuntime>::on_initialize(
			frame_system::Pallet::<PintRuntime>::block_number(),
		);
	}
}
