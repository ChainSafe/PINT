...
use crate::{ALICE, PARA_ASSET, RELAY_CHAIN_ASSET};
use codec::Decode;
...
use pint_runtime_kusama::{PalletProxyEncoder, PalletStakingEncoder};
use polkadot_parachain::primitives::Sibling;
use polkadot_primitives::v1::AccountId;
use primitives::{traits::MultiAssetRegistry, *};
use sp_core::H256;
use sp_runtime::traits::{AccountIdConversion, AccountIdLookup, Convert, Zero};
...
pub type XcmRouter = pint_runtime_kusama::XcmRouter;
...
impl orml_xtokens::Config for Runtime {
	...
	type AccountIdToMultiLocation = pint_runtime_kusama::AccountId32Convert;
...
parameter_types! {
	pub LockupPeriod: <Runtime as frame_system::Config>::BlockNumber = 0;
...
ord_parameter_types! {
	pub const AdminAccountId: AccountId = ALICE;
}
